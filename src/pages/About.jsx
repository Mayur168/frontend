...
//         <div className="container section-title text-center" data-aos="zoom">
//           <h2>Resume</h2>
//           <p>
  ...
  return (
    <div className="bg-light min-vh-100">
      <section id="about" className="py-8 bg-white">
        <div className="container" data-aos="fade-up" data-aos-delay="100">
          <div className="row g-4">
              ...
              <div className="row g-4 mb-4">
                ...
                <div className="col-md-7">
                  <ul className="list-unstyled">
                    ...
                    <li className="mb-2">
                      <strong>Phone: </strong>
                      <span>+91 7447849409</span>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="mt-4">
                <h5 className="h4 mb-3">Skills</h5>
                {[
            ...
            <div className="col-lg-6">
              <h4 className="h3 text-center mb-4">About Me</h4>
              <div className="card border-0 shadow-sm p-4">
                <p>
                  I’m Mayur Gaikwad, a Software Developer from Nashik, India, passionate about crafting innovative web solutions. With a BCS degree from K. V. N. Naik College (77.83%, 2018–2021), HSC at D. D. Bytco Junior College (55.23%, 2016–2018), and SSC at Modern Education Society (76.20%, 2015–2016).
                </p>
                <p>
                ...
                <p>
                  I specialize in Python, Django, React.js, and TanStack Query, delivering impactful applications across diverse sectors. I enjoy traveling and bike riding, which inspire my creative solutions.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="resume" className="py-5 bg-light">
        <div className="container">
          <div className="text-center mb-5" data-aos="zoom">
            <h2 className="h1 fw-bold">Resume</h2>
            <p className="text-muted">A snapshot of my professional journey and achievements</p>
          </div>
          <div className="row g-4">
            <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              <h3 className="h4 fw-bold mb-4">@ Summary</h3>
              <div className="card border-0 shadow-sm p-4">
                <h4 className="h5 fw-bold">Mayur Gaikwad</h4>
                <p className="text-muted fst-italic">
                  Passionate and detail-oriented React Developer with 1 year of experience at Heuristic Technopark. Skilled in building responsive web applications and backend systems using Python and Django. Eager to contribute to software development projects that solve real-world problems.
                </p>
                <ul className="list-unstyled mt-3">
                  <li>Heuristic Technopark, Nashik, India</li>
                  <li>+91 7447849409</li>
                  <li>mayurgaikwad1442@gmail.com</li>
                </ul>
              </div>
              <h3 className="h4 fw-bold mt-5 mb-4">@ Education</h3>
              {[
                {
                  title: "Bachelor of Science in Computer Science",
                  period: "2018 - 2021",
                  institution: "K.V.N. Naik College, Nashik — Affiliated to Pune University",
                  description: "Completed B.Sc. in Computer Science with a 73% aggregate. Gained solid foundations in software development, programming, and database management.",
                },
                {
                  title: "Higher Secondary Certificate (HSC)",
                  period: "2016 - 2018",
                  institution: "D.D. Bytco College, Nashik — Affiliated to Pune University",
                  description: "Completed HSC with 56% in the science stream, focusing on mathematics and computer science.",
                },
                {
                  title: "Secondary School Certificate (SSC)",
                  period: "2015 - 2016",
                  institution: "Modern High School, Nashik — Affiliated to Pune University",
                  description: "Completed SSC with 76%, developing strong academic discipline and interest in computer fundamentals.",
                },
              ].map((edu, index) => (
                <div key={index} className="card border-0 shadow-sm p-4 mb-3">
                  <h4 className="h5 fw-bold">{edu.title}</h4>
                  <h5 className="text-muted">{edu.period}</h5>
                  <p className="text-muted fst-italic">{edu.institution}</p>
                  <p className="text-muted">{edu.description}</p>
                </div>
              ))}
            </div>
            <div className="col-lg-6" data-aos="fade-up" data-aos-delay="200">
              <h3 className="h4 fw-bold mb-4">@ Professional Experience</h3>
              {[
                {
                  ...
                  responsibilities: [
                    "Working as a full-stack developer focused on React.js for frontend and Django for backend development.",
                    "Contributed to building ERP solutions and multiple custom web applications for clients across various domains.",
                    "Developed REST APIs, integrated frontend with backend systems, and implemented responsive UI using React.",
                ...
                },
                {
                  ...
                  period: "2022 - 2023",
                  company: "Cufront Healthcare Pvt. Ltd., Nashik",
                  responsibilities: [
                    "Built and maintained web applications for healthcare solutions using Django.",
                    "Created secure backend logic, user authentication systems, and dynamic dashboards for internal users.",
                    "Optimized database models and queries to improve performance and scalability.",
                  ],
                },
                {
                  title: "Python Django Intern",
                  period: "2021 - 2022",
                  company: "Heuristic Tech, Nashik",
                  responsibilities: [
                    "Completed 6-month internship focused on backend development using Django.",
                    "Assisted in building basic modules like user registration, login, and CRUD operations.",
                    "Learned practical development workflows, Git usage, and project deployment practices.",
                  ],
                },
              ].map((exp, index) => (
                <div key={index} className="card border-0 shadow-sm p-4 mb-3">
                  <h4 className="h5 fw-bold">{exp.title}</h4>
                  <h5 className="text-muted">{exp.period}</h5>
                  <p className="text-muted fst-italic">{exp.company}</p>
                  <ul className="list-group list-group-flush">
                    {exp.responsibilities.map((resp, idx) => (
                      <li key={idx} className="list-group-item border-0 ps-0">{resp}</li>
                    ))}
                  </ul>
                </div>
              ))}
